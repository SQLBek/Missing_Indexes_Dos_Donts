/*-----------------------------------------------------------------------------
-- 5_Workload Analysis.sql
--
-- Written By: Andy Yun
-- Created On: 2021-10-19
-- 
-- Summary: 
-- Use in conjunction with Missing Index DMV Template.xlsx
-----------------------------------------------------------------------------*/
USE CookbookDemo
GO
...
-----
-- Individual Queries - Detailed
--
-- Grab an index_group_handle and add to predicate
SELECT
	dm_db_missing_index_groups.index_group_handle,
...
WHERE dm_db_missing_index_groups.index_group_handle = 39
